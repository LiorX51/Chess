...
Queen::Queen(const std::string name, const std::string start_pos, const bool is_white) : Figure(name, start_pos, is_white)
{
}

bool Queen::does_attack(const std::string Point)
{
	bool r_val = true;
